...
---
---[<a href="https://github.com/beyond-all-reason/spring/blob/e36cb76f2df53b31c339da1ed0634b24d2e95b12/rts/Lua/LuaConstCMDTYPE.cpp#L12-L15" target="_blank">source</a>]
---
---@see rts/Lua/LuaConstCMDTYPE.cpp

---Note, the CMDTYPE[] table is bidirectional. That means: CMDTYPE[CMDTYPE.ICON] := "CMDTYPE_ICON"
---
---[<a href="https://github.com/beyond-all-reason/spring/blob/e36cb76f2df53b31c339da1ed0634b24d2e95b12/rts/Lua/LuaConstCMDTYPE.cpp#L17-L36" target="_blank">source</a>]
---
---@enum CMDTYPE
CMDTYPE = {
