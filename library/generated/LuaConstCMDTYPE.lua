...
---
---[<a href="https://github.com/beyond-all-reason/spring/blob/0765843e1a0b55c419cd5b79b02fae7e1c3ea5c6/rts/Lua/LuaConstCMDTYPE.cpp#L12-L15" target="_blank">source</a>]
---
---@see rts/Lua/LuaConstCMDTYPE.cpp

---Note, the CMDTYPE[] table is bidirectional. That means: CMDTYPE[CMDTYPE.ICON] := "CMDTYPE_ICON"
---
---[<a href="https://github.com/beyond-all-reason/spring/blob/0765843e1a0b55c419cd5b79b02fae7e1c3ea5c6/rts/Lua/LuaConstCMDTYPE.cpp#L17-L36" target="_blank">source</a>]
---
---@enum CMDTYPE
CMDTYPE = {
