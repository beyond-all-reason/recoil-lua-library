...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L294-L299" target="_blank">source</a>]
---
---@param name string
---@return string?
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L301-L306" target="_blank">source</a>]
---
---@param id string
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L308-L313" target="_blank">source</a>]
---
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L315-L320" target="_blank">source</a>]
---
---@param query string
---@return RmlUi.ElementPtr?
...
---JQuery-like element selector
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L322-L327" target="_blank">source</a>]
---
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L329-L334" target="_blank">source</a>]
---
---@param selectors string
---@return boolean
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L336-L341" target="_blank">source</a>]
---
---@param name string
---@return boolean
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L343-L347" target="_blank">source</a>]
---
---@return boolean
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L349-L355" target="_blank">source</a>]
---
---@param element RmlUi.ElementPtr
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L359-L364" target="_blank">source</a>]
---
---@param name string
---@return boolean
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L366-L370" target="_blank">source</a>]
---
---@param name string
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L372-L377" target="_blank">source</a>]
---
---@param element RmlUi.Element
---@return boolean
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L379-L385" target="_blank">source</a>]
---
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L389-L393" target="_blank">source</a>]
---
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L400-L405" target="_blank">source</a>]
---
---@param name string
---@param value string
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L407-L412" target="_blank">source</a>]
---
---@param name string
---@param value boolean
function RmlUi.Element:SetClass(name, value) end

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L415-L419" target="_blank">source</a>]
---
---@param class_name string
---@return RmlUi.Element[]
function RmlUi.Element:GetElementsByClassName(class_name) end

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L421-L424" target="_blank">source</a>]
---
---@return RmlUi.ElementPtr
function RmlUi.Element:Clone() end

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L426-L429" target="_blank">source</a>]
---
---@return RmlUi.Element?
function RmlUi.Element:Closest() end

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L431-L434" target="_blank">source</a>]
---
---@param class_name string
function RmlUi.Element:SetPseudoClass(class_name) end

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L436-L440" target="_blank">source</a>]
---
---@param class_name string
---@return boolean
function RmlUi.Element:IsPseudoClassSet(class_name) end

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L442-L446" target="_blank">source</a>]
---
---@param class_names string[]
---@return boolean
function RmlUi.Element:ArePseudoCLassesSet(class_names) end

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L448-L451" target="_blank">source</a>]
---
---@return string[]
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L453-L458" target="_blank">source</a>]
---
---@param point RmlUi.Vector2i
---@return boolean
function RmlUi.Element:IsPointWithinElement(point) end

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L460-L463" target="_blank">source</a>]
---
---@param event RmlUi.Event
function RmlUi.Element:ProcessDefaultAction(event) end

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L465-L469" target="_blank">source</a>]
---
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L474-L478" target="_blank">source</a>]
---
...
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L487-L491" target="_blank">source</a>]
---
---@param index integer
---@return RmlUi.Element?
...
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L550-L550" target="_blank">source</a>]
---Read-only. The address of the element in the document tree.
---
---@type string
RmlUi.Element.address = nil

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L552-L552" target="_blank">source</a>]
---Read-only. The absolute left position of the element relative to the document.
---
---@type integer
RmlUi.Element.absolute_left = nil

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L554-L554" target="_blank">source</a>]
---Read-only. The absolute top position of the element relative to the document.
---
---@type integer
RmlUi.Element.absolute_top = nil

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L556-L556" target="_blank">source</a>]
---Read-only. The baseline position of the element.
---
---@type integer
RmlUi.Element.baseline = nil

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L558-L558" target="_blank">source</a>]
---Read-only. The computed line height of the element.
---
---@type integer
RmlUi.Element.line_height = nil

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L560-L560" target="_blank">source</a>]
---Read-only. True if the element is visible, false otherwise.
---
---@type boolean
RmlUi.Element.visible = nil

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/master/rts/Rml/SolLua/bind/Element.cpp#L562-L562" target="_blank">source</a>]
