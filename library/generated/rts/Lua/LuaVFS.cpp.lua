...
---  - `validmaps.lua`
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L27-L145" target="_blank">source</a>]
VFS = {}

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L150-L150" target="_blank">source</a>]
---Only select uncompressed files.
VFS.RAW = "r"

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L152-L152" target="_blank">source</a>]
VFS.GAME = "M"

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L154-L154" target="_blank">source</a>]
VFS.MAP = "m"

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L156-L156" target="_blank">source</a>]
VFS.BASE = "b"

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L158-L158" target="_blank">source</a>]
VFS.MENU = "e"

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L160-L160" target="_blank">source</a>]
---Only select compressed files (`.sdz`, `.sd7`).
VFS.ZIP = "Mmeb"

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L162-L162" target="_blank">source</a>]
---Try uncompressed files first, then compressed.
VFS.RAW_FIRST = "rMmeb"

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L164-L164" target="_blank">source</a>]
---Try compressed files first, then uncompressed.
VFS.ZIP_FIRST = "Mmebr"

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L167-L170" target="_blank">source</a>]
---
---@deprecated
---Older spelling for `VFS.GAME`
VFS.MOD = "M"

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L172-L175" target="_blank">source</a>]
---
---@deprecated
VFS.RAW_ONLY = "r"

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L177-L180" target="_blank">source</a>]
---
---@deprecated
VFS.ZIP_ONLY = "Mmeb"
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L276-L310" target="_blank">source</a>]
---
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L394-L414" target="_blank">source</a>]
---
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L445-L470" target="_blank">source</a>]
---
---Example usage:
---
---```lua
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L491-L518" target="_blank">source</a>]
---
---Example usage:
---
---```lua
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L550-L580" target="_blank">source</a>]
---
---Example usage:
---
---```lua
...
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L608-L623" target="_blank">source</a>]
---
---@param filename string
---
---Path to file, lowercase only. Use linux style path separators, e.g.
...
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L647-L662" target="_blank">source</a>]
---
---@param filename string
---
---Path to file, lowercase only. Use linux style path separators, e.g.
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L687-L695" target="_blank">source</a>]
---
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L815-L825" target="_blank">source</a>]
---
...
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L861-L865" target="_blank">source</a>]
---
...
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L881-L885" target="_blank">source</a>]
---
...
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L902-L906" target="_blank">source</a>]
---
---@alias HashType
---| 0 # MD5
---| 1 # SHA512
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L908-L918" target="_blank">source</a>]
---
---@param input string
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L1000-L1005" target="_blank">source</a>]
---
...
---Convert unsigned 8-bit integer(s) to binary string.
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L1006-L1011" target="_blank">source</a>]
---
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L1014-L1019" target="_blank">source</a>]
---
---@param ... integer Numbers to pack.
---@return string
...
---Convert unsigned 16-bit integer(s) to binary string.
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L1020-L1025" target="_blank">source</a>]
---
---@param numbers integer[] Numbers to pack.
---@return string
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L1028-L1033" target="_blank">source</a>]
---
---@param ... integer Numbers to pack.
---@return string
...
---Convert unsigned 32-bit integer(s) to binary string.
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L1034-L1039" target="_blank">source</a>]
---
---@param numbers integer[] Numbers to pack.
---@return string
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L1042-L1047" target="_blank">source</a>]
---
---@param ... integer Numbers to pack.
---@return string
...
---Convert signed 8-bit integer(s) to binary string.
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L1048-L1053" target="_blank">source</a>]
---
---@param numbers integer[] Numbers to pack.
---@return string
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L1056-L1061" target="_blank">source</a>]
---
---@param ... integer Numbers to pack.
---@return string
...
---Convert signed 16-bit integer(s) to binary string.
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L1062-L1067" target="_blank">source</a>]
---
---@param numbers integer[] Numbers to pack.
---@return string
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L1070-L1075" target="_blank">source</a>]
---
---@param ... integer Numbers to pack.
---@return string
...
---Convert signed 32-bit integer(s) to binary string.
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L1076-L1081" target="_blank">source</a>]
---
---@param numbers integer[] Numbers to pack.
---@return string
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L1084-L1089" target="_blank">source</a>]
---
---@param ... integer Numbers to pack.
---@return string
function VFS.PackS32(...) end
...
---Convert signed 32-bit float(s) to binary string.
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L1090-L1095" target="_blank">source</a>]
---
---@param numbers integer[] Numbers to pack.
---@return string
function VFS.PackS32(numbers) end
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L1143-L1149" target="_blank">source</a>]
---
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L1152-L1158" target="_blank">source</a>]
---
---@param str string Binary string.
---@param pos integer? Byte offset.
---@return integer
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L1161-L1167" target="_blank">source</a>]
---
---@param str string Binary string.
---@param pos integer? Byte offset.
---@return integer
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L1170-L1176" target="_blank">source</a>]
---
---@param str string Binary string.
---@param pos integer? Byte offset.
---@return integer
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L1179-L1185" target="_blank">source</a>]
---
---@param str string Binary string.
---@param pos integer? Byte offset.
---@return integer
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L1188-L1194" target="_blank">source</a>]
---
---@param str string Binary string.
---@param pos integer? Byte offset.
---@return integer
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/59bc2076754bc7bbf827603f4be80f4196abaf90/rts/Lua/LuaVFS.cpp#L1197-L1203" target="_blank">source</a>]
---
---@param str string Binary string.
---@param pos integer? Byte offset.
---@return integer
