...
---  - `validmaps.lua`
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L27-L145" target="_blank">source</a>]
VFS = {}

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L150-L150" target="_blank">source</a>]
---Only select uncompressed files.
VFS.RAW = "r"

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L152-L152" target="_blank">source</a>]
VFS.GAME = "M"

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L154-L154" target="_blank">source</a>]
VFS.MAP = "m"

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L156-L156" target="_blank">source</a>]
VFS.BASE = "b"

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L158-L158" target="_blank">source</a>]
VFS.MENU = "e"

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L160-L160" target="_blank">source</a>]
---Only select compressed files (`.sdz`, `.sd7`).
VFS.ZIP = "Mmeb"

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L162-L162" target="_blank">source</a>]
---Try uncompressed files first, then compressed.
VFS.RAW_FIRST = "rMmeb"

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L164-L164" target="_blank">source</a>]
---Try compressed files first, then uncompressed.
VFS.ZIP_FIRST = "Mmebr"

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L167-L170" target="_blank">source</a>]
---
---@deprecated
---Older spelling for `VFS.GAME`
VFS.MOD = "M"

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L172-L175" target="_blank">source</a>]
---
---@deprecated
VFS.RAW_ONLY = "r"

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L177-L180" target="_blank">source</a>]
---
---@deprecated
VFS.ZIP_ONLY = "Mmeb"
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L276-L310" target="_blank">source</a>]
---
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L394-L414" target="_blank">source</a>]
---
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L445-L470" target="_blank">source</a>]
---
---Example usage:
---
---```lua
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L491-L518" target="_blank">source</a>]
---
---Example usage:
---
---```lua
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L550-L580" target="_blank">source</a>]
---
---Example usage:
---
---```lua
...
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L608-L623" target="_blank">source</a>]
---
---@param filename string
---
---Path to file, lowercase only. Use linux style path separators, e.g.
...
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L647-L662" target="_blank">source</a>]
---
---@param filename string
---
---Path to file, lowercase only. Use linux style path separators, e.g.
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L687-L695" target="_blank">source</a>]
---
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L815-L825" target="_blank">source</a>]
---
...
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L861-L865" target="_blank">source</a>]
---
...
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L881-L885" target="_blank">source</a>]
---
...
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L902-L906" target="_blank">source</a>]
---
---@alias HashType
---| 0 # MD5
---| 1 # SHA512
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L908-L915" target="_blank">source</a>]
---
---@param input string
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L997-L1002" target="_blank">source</a>]
---
...
---Convert unsigned 8-bit integer(s) to binary string.
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L1003-L1008" target="_blank">source</a>]
---
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L1011-L1016" target="_blank">source</a>]
---
---@param ... integer Numbers to pack.
---@return string
...
---Convert unsigned 16-bit integer(s) to binary string.
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L1017-L1022" target="_blank">source</a>]
---
---@param numbers integer[] Numbers to pack.
---@return string
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L1025-L1030" target="_blank">source</a>]
---
---@param ... integer Numbers to pack.
---@return string
...
---Convert unsigned 32-bit integer(s) to binary string.
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L1031-L1036" target="_blank">source</a>]
---
---@param numbers integer[] Numbers to pack.
---@return string
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L1039-L1044" target="_blank">source</a>]
---
---@param ... integer Numbers to pack.
---@return string
...
---Convert signed 8-bit integer(s) to binary string.
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L1045-L1050" target="_blank">source</a>]
---
---@param numbers integer[] Numbers to pack.
---@return string
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L1053-L1058" target="_blank">source</a>]
---
---@param ... integer Numbers to pack.
---@return string
...
---Convert signed 16-bit integer(s) to binary string.
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L1059-L1064" target="_blank">source</a>]
---
---@param numbers integer[] Numbers to pack.
---@return string
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L1067-L1072" target="_blank">source</a>]
---
---@param ... integer Numbers to pack.
---@return string
...
---Convert signed 32-bit integer(s) to binary string.
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L1073-L1078" target="_blank">source</a>]
---
---@param numbers integer[] Numbers to pack.
---@return string
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L1081-L1086" target="_blank">source</a>]
---
---@param ... integer Numbers to pack.
---@return string
function VFS.PackS32(...) end
...
---Convert signed 32-bit float(s) to binary string.
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L1087-L1092" target="_blank">source</a>]
---
---@param numbers integer[] Numbers to pack.
---@return string
function VFS.PackS32(numbers) end
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L1140-L1146" target="_blank">source</a>]
---
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L1149-L1155" target="_blank">source</a>]
---
---@param str string Binary string.
---@param pos integer? Byte offset.
---@return integer
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L1158-L1164" target="_blank">source</a>]
---
---@param str string Binary string.
---@param pos integer? Byte offset.
---@return integer
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L1167-L1173" target="_blank">source</a>]
---
---@param str string Binary string.
---@param pos integer? Byte offset.
---@return integer
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L1176-L1182" target="_blank">source</a>]
---
---@param str string Binary string.
---@param pos integer? Byte offset.
---@return integer
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L1185-L1191" target="_blank">source</a>]
---
---@param str string Binary string.
---@param pos integer? Byte offset.
---@return integer
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVFS.cpp#L1194-L1200" target="_blank">source</a>]
---
---@param str string Binary string.
---@param pos integer? Byte offset.
---@return integer
