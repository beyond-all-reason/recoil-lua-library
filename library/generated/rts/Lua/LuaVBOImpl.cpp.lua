...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVBOImpl.cpp#L35-L41" target="_blank">source</a>]
---
---@class VBO
---@see LuaVBO.GetVBO
...
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVBOImpl.cpp#L109-L113" target="_blank">source</a>]
---
---@return nil
function VBO:Delete() end

---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVBOImpl.cpp#L459-L494" target="_blank">source</a>]
---
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVBOImpl.cpp#L496-L534" target="_blank">source</a>]
---
...
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVBOImpl.cpp#L582-L588" target="_blank">source</a>]
---
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVBOImpl.cpp#L599-L620" target="_blank">source</a>]
---
...
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVBOImpl.cpp#L663-L674" target="_blank">source</a>]
---
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVBOImpl.cpp#L1172-L1179" target="_blank">source</a>]
---
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVBOImpl.cpp#L1191-L1216" target="_blank">source</a>]
---
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVBOImpl.cpp#L1230-L1255" target="_blank">source</a>]
---
---The instance data in that attribute will contain the offset to bind position
---matrix in global matrices SSBO and offset to uniform buffer structure in
---global per unit/feature uniform SSBO (unused for Unit/FeatureDefs), as
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVBOImpl.cpp#L1269-L1295" target="_blank">source</a>]
---
---The instance data in that attribute will contain the offset to bind position
---matrix in global matrices SSBO and offset to uniform buffer structure in
---global per unit/feature uniform SSBO (unused for Unit/FeatureDefs), as
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVBOImpl.cpp#L1307-L1323" target="_blank">source</a>]
---
---The instance data in that attribute will contain the offset to bind position
---matrix in global matrices SSBO and offset to uniform buffer structure in
---global per unit/feature uniform SSBO (unused for Unit/FeatureDefs), as
...
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVBOImpl.cpp#L1335-L1345" target="_blank">source</a>]
---
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVBOImpl.cpp#L1417-L1431" target="_blank">source</a>]
---
---Generally mimics
...
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVBOImpl.cpp#L1438-L1446" target="_blank">source</a>]
---
---@param index integer
---@param elementOffset integer?
---@param elementCount number?
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVBOImpl.cpp#L1453-L1457" target="_blank">source</a>]
---
---@return nil
...
---
---[<a href="https://github.com/beyond-all-reason/RecoilEngine/blob/4d81b4fe86bfb803f0f75e47d0755c101f4127e8/rts/Lua/LuaVBOImpl.cpp#L1474-L1478" target="_blank">source</a>]
---
