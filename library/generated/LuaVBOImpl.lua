...
---
---[<a href="https://github.com/beyond-all-reason/spring/blob/cc3172342a8bfb879cf4342d7ad0ab478225f83f/rts/Lua/LuaVBOImpl.cpp#L35-L41" target="_blank">source</a>]
---
---@class VBO
---@see LuaVBO.GetVBO
...
---[<a href="https://github.com/beyond-all-reason/spring/blob/cc3172342a8bfb879cf4342d7ad0ab478225f83f/rts/Lua/LuaVBOImpl.cpp#L109-L113" target="_blank">source</a>]
---
---@return nil
function VBO:Delete() end

---[<a href="https://github.com/beyond-all-reason/spring/blob/cc3172342a8bfb879cf4342d7ad0ab478225f83f/rts/Lua/LuaVBOImpl.cpp#L459-L468" target="_blank">source</a>]
---
---@alias VBODataType
---| GL.BYTE
---| GL.UNSIGNED_BYTE
...
---[<a href="https://github.com/beyond-all-reason/spring/blob/cc3172342a8bfb879cf4342d7ad0ab478225f83f/rts/Lua/LuaVBOImpl.cpp#L470-L497" target="_blank">source</a>]
---
...
---```lua
---
---[<a href="https://github.com/beyond-all-reason/spring/blob/cc3172342a8bfb879cf4342d7ad0ab478225f83f/rts/Lua/LuaVBOImpl.cpp#L500-L538" target="_blank">source</a>]
---
...
---[<a href="https://github.com/beyond-all-reason/spring/blob/cc3172342a8bfb879cf4342d7ad0ab478225f83f/rts/Lua/LuaVBOImpl.cpp#L586-L592" target="_blank">source</a>]
---
...
---```lua
---
---[<a href="https://github.com/beyond-all-reason/spring/blob/cc3172342a8bfb879cf4342d7ad0ab478225f83f/rts/Lua/LuaVBOImpl.cpp#L603-L635" target="_blank">source</a>]
---
...
---[<a href="https://github.com/beyond-all-reason/spring/blob/cc3172342a8bfb879cf4342d7ad0ab478225f83f/rts/Lua/LuaVBOImpl.cpp#L678-L689" target="_blank">source</a>]
---
...
---
---[<a href="https://github.com/beyond-all-reason/spring/blob/cc3172342a8bfb879cf4342d7ad0ab478225f83f/rts/Lua/LuaVBOImpl.cpp#L1187-L1194" target="_blank">source</a>]
---
...
---
---[<a href="https://github.com/beyond-all-reason/spring/blob/cc3172342a8bfb879cf4342d7ad0ab478225f83f/rts/Lua/LuaVBOImpl.cpp#L1206-L1231" target="_blank">source</a>]
---
...
---
---[<a href="https://github.com/beyond-all-reason/spring/blob/cc3172342a8bfb879cf4342d7ad0ab478225f83f/rts/Lua/LuaVBOImpl.cpp#L1245-L1270" target="_blank">source</a>]
---
---The instance data in that attribute will contain the offset to bind position
---matrix in global matrices SSBO and offset to uniform buffer structure in
---global per unit/feature uniform SSBO (unused for Unit/FeatureDefs), as
...
---
---[<a href="https://github.com/beyond-all-reason/spring/blob/cc3172342a8bfb879cf4342d7ad0ab478225f83f/rts/Lua/LuaVBOImpl.cpp#L1284-L1310" target="_blank">source</a>]
---
---The instance data in that attribute will contain the offset to bind position
---matrix in global matrices SSBO and offset to uniform buffer structure in
---global per unit/feature uniform SSBO (unused for Unit/FeatureDefs), as
...
---
---[<a href="https://github.com/beyond-all-reason/spring/blob/cc3172342a8bfb879cf4342d7ad0ab478225f83f/rts/Lua/LuaVBOImpl.cpp#L1322-L1338" target="_blank">source</a>]
---
---The instance data in that attribute will contain the offset to bind position
---matrix in global matrices SSBO and offset to uniform buffer structure in
---global per unit/feature uniform SSBO (unused for Unit/FeatureDefs), as
...
---[<a href="https://github.com/beyond-all-reason/spring/blob/cc3172342a8bfb879cf4342d7ad0ab478225f83f/rts/Lua/LuaVBOImpl.cpp#L1350-L1360" target="_blank">source</a>]
---
...
---
---[<a href="https://github.com/beyond-all-reason/spring/blob/cc3172342a8bfb879cf4342d7ad0ab478225f83f/rts/Lua/LuaVBOImpl.cpp#L1432-L1446" target="_blank">source</a>]
---
---Generally mimics
...
---[<a href="https://github.com/beyond-all-reason/spring/blob/cc3172342a8bfb879cf4342d7ad0ab478225f83f/rts/Lua/LuaVBOImpl.cpp#L1453-L1461" target="_blank">source</a>]
---
---@param index integer
---@param elementOffset integer?
---@param elementCount number?
...
---
---[<a href="https://github.com/beyond-all-reason/spring/blob/cc3172342a8bfb879cf4342d7ad0ab478225f83f/rts/Lua/LuaVBOImpl.cpp#L1468-L1472" target="_blank">source</a>]
---
---@return nil
...
---
---[<a href="https://github.com/beyond-all-reason/spring/blob/cc3172342a8bfb879cf4342d7ad0ab478225f83f/rts/Lua/LuaVBOImpl.cpp#L1489-L1493" target="_blank">source</a>]
---
